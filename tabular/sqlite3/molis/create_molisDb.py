import sqlite3
import pandas as pd
conn = sqlite3.connect("/home/phe.gov.uk/juan.ledesma/gluetools/projects/hcv_glue_avu/sqlite3/molis/molis.db") # create the database
...
STAT_ORD_csv = pd.read_csv('/home/phe.gov.uk/juan.ledesma/gluetools/projects/hcv_glue_avu/sqlite3/molis/STAT_ORD.csv')
STAT_ORD_csv.to_sql('STAT_ORD', conn, if_exists='append', index = False)

STAT_ORDANAEL_csv = pd.read_csv('/home/phe.gov.uk/juan.ledesma/gluetools/projects/hcv_glue_avu/sqlite3/molis/STAT_ORDANAEL.csv')
STAT_ORDANAEL_csv.to_sql('STAT_ORDANAEL', conn, if_exists='append', index = False)

STAT_SAMPLEPOS_CONT_V_csv = pd.read_csv('/home/phe.gov.uk/juan.ledesma/gluetools/projects/hcv_glue_avu/sqlite3/molis/STAT_SAMPLEPOS_CONT_V.csv')
STAT_SAMPLEPOS_CONT_V_csv.to_sql('STAT_SAMPLEPOS_CONT_V', conn, if_exists='append', index = False)

STAT_COR_csv = pd.read_csv('/home/phe.gov.uk/juan.ledesma/gluetools/projects/hcv_glue_avu/sqlite3/molis/STAT_COR.csv')
